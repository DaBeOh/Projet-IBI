...
gatk -T SelectVariants -R ../../genome/fichier.fa 
-V ../../part2_var_calling/fichier.vcf -selectType SNP -o fichier.vcf


##Filtrer nos SNP selon les paramètres de seuils recommandés par GATK:

# Bos_taurus.UMD3.1.dna.toplevel.6.fa -- 
gatk -T VariantFiltration -R ../../genome/fichier.fa 
-V fichier.vcf --filterExpression "QD < 2.0 || FS > 60.0 ||
 MQ < 40.0 || MQRankSum < -12.5 || ReadPosRankSum < -8.0" 
 --filterName "hard_filtering_snp" -o fichier.vcf
